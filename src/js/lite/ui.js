...
const linkDialog = function(opt) {
  const body = '<div class="note-form-group">' +
      '<label for="note-dialog-link-text-' + opt.id + '" class="note-form-label">' + opt.lang.link.textToDisplay + '</label>' +
      '<input id="note-dialog-link-text-' + opt.id + '" class="note-link-text note-input" type="text"/>' +
    '</div>' +
    ...
    (!opt.disableLinkTarget
      ? '<div class="checkbox">' +
        '<input id="note-dialog-link-nw-' + opt.id + '" type="checkbox" checked>' +
        '<label for="note-dialog-link-nw-' + opt.id + '">' + opt.lang.link.openInNewWindow + '</label>' +
      '</div>' : ''
    ) +
    '<div class="checkbox">' +
      '<input id="note-dialog-link-protocol-' + opt.id + '" type="checkbox" checked> ' +
      '<label for="note-dialog-link-protocol-' + opt.id + '">' +  + opt.lang.link.useProtocol + '</label>' +
    '</div>'
    ;
  const footer = [
