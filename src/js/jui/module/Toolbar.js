define([
  ...
  var Toolbar = function (summernote) {
    ...
    this.updateFullscreen = function (isFullscreen) {
      $toolbar.find('.btn-fullscreen').toggleClass('active focus', isFullscreen);
    };

    this.updateCodeview = function (isCodeview) {
      $toolbar.find('.btn-codeview').toggleClass('active focus', isCodeview);
    };
    ...
    this.initialize = function () {
      ...
      $toolbar.append(ui.buttonGroup([
        ui.button({
          ...
          contents: '<i class="icon-edit" /> <i class="icon-arrow1" />',
          tooltip: 'Style',
          data :  {
            toggle : 'dropdown'
          }
      ...
      $toolbar.append(ui.buttonGroup([
        ui.button({
          className: 'dropdown-toggle',
          contents: '<a class="inline note-current-fontname" /> <i class="icon-arrow1" />',
          tooltip: 'Font Family',
          data: {
            toggle: 'dropdown'
          }
      ...
      $toolbar.append(ui.buttonGroup([
        ui.button({
          className: 'dropdown-toggle',
          contents: '<a class="inline note-current-fontsize" /> <i class="icon-arrow1" />',
          tooltip: 'Font Size',
          data: {
            toggle: 'dropdown'
          }
      ...
      $toolbar.append(ui.buttonGroup([
        ui.button({
          contents: '<i class="icon-textcolor note-recent-color"/>',
      ...
      $toolbar.append(ui.buttonGroup([
        ...
        ui.buttonGroup([
          ui.button({
            className: 'dropdown-toggle',
            contents: '<i class="icon-align-left"/> <i class="icon-arrow1" />',
          ...
          ui.dropdown([
            ...
            className : 'note-para-align-list'
          })
        ])
      ], {
        className: 'note-para'
      ...
      $toolbar.append(ui.buttonGroup([
        ui.button({
          className: 'dropdown-toggle line-height',
          contents: '<i class="icon-text"/> <i class="icon-arrow1" />',
          data: {
            toggle: 'dropdown'
          }
        }),
      ...
      $toolbar.append(ui.buttonGroup([
        ui.button({
          className: 'dropdown-toggle',
          contents: '<i class="icon-table"/> <i class="icon-arrow1" />',
          data: {
            toggle: 'dropdown'
          }
        }),
      ...
      $toolbar.append(ui.buttonGroup([
        ui.button({
          ...
          contents: '<i class="icon-new-window"/>',
          click: this.createInvokeHandler('fullscreen.toggle')
        }),
        ui.button({
          className: 'btn-codeview',
          contents: '<i class="icon-html"/>',
