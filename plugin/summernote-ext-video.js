(function ($) {
   ...
   * @return {Node}
   */
  var createVideoNode = function (videoInfo) {
    ...
    var $wrapper = $('<div class="video-wrapper"></div>').attr('data-original-url', url).css(wrapperStyle).append($video);
   ...
   * @return {Promise}
   */
  var showVideoDialog = function ($editable, $dialog, videoInfo) {
  ...
  $.summernote.addPlugin({
    ...
    events: {
      ...
      showVideoDialog: function (layoutInfo) {
        ...
        showVideoDialog($editable, $dialog, videoInfo).then(function (videoInfo) {
