...
define([
  ...
  describe('core.dom', function () {
    ...
    describe('buildLayoutInfo', function () {
      it('should return layoutInfo', function () {
    ...
    describe('makeLayoutInfo', function () {
      it('should return layoutInfo', function () {
        var $editor = $(editorMarkup);
      ...
      it('should return null if there is no editor area', function () {
        expect(dom.makeLayoutInfo($('<div></div>'))).to.be.null;
      });
    });
    ...
    describe('splitTree', function () {
      ...
      describe('textNode case', function () {
        ...
        it('should be splited by span tag with offset 2 (1 depth and element case)', function () {
          ...
          helper.equalsToUpperCase($cont.html(), '<p><span><b>b</b><u>u</u></span><span><s>s</s><i>i</i></span></p>', expect);
        });
      });
    });
